    ...
    myApp.controller('studentsController',['$scope', '$http', '$location', '$routeParams','$anchorScroll','$templateCache', function($scope, $http, $location,  $routeParams, $anchorScroll, $templateCache){
       ...
       //$templateCache.removeAll();
        ...
        $http({
            method : "POST",
            url : "http://recruitment.studyinbudapest.com/authentication",
            data: codeprintdata
      ...
      /*  var foucused;
        ...
        console.log(foucused);    
         ...
         /* START NOTIFICATION SETTINGS*/ 
            $http({
            method : "POST",
            url : "http://recruitment.studyinbudapest.com/allstudents",
            data: codeprintdata
            }).then(function  (response){
           ...
           // alert(currentnumberofstudents);          
            ...
            var uid = userid;
            var editurl = "http://recruitment.studyinbudapest.com/edit/universities/applied/" + uid
     ...
     /*END OF NOTIFICATION SETTINGS*/          
       ...
       if (accountinactive) {
            swal({   
                ...
                var resendurl = "http://recruitment.studyinbudapest.com/resend/verifymail";
                var data = {
       ...
       var verificationurl = "http://recruitment.studyinbudapest.com/verify/" + useremail 
       $http({
            method : "POST",
            url : verificationurl,
            data: codeprintdata
       ...
       var useremail = $routeParams.email;
       var activationurl = "http://recruitment.studyinbudapest.com/activate/" + useremail 
       $http({
            method : "POST",
            url : activationurl,
            data: codeprintdata
       ...
       var unsuburl = "http://recruitment.studyinbudapest.com/university/unsubscribe/" + useremail +"/" + uid
       $http({
            method : "POST",
            url : unsuburl,
            data: codeprintdata
       ...
       var rpurl = "http://recruitment.studyinbudapest.com/reset"
...
//$http.get('http://recruitment.studyinbudapest.com/profile/students/'+ id)
         $http({
            method : "POST",
            url : "http://recruitment.studyinbudapest.com/profile/students/"+id,
            data: codeprintdata
        }).then(function(response){
    ...
    $scope.getUniversity = function (){
        ...
        //OR
        var id = $routeParams.id; 
        /*$http.get('http://recruitment.studyinbudapest.com/universities/'+ id)*/
       $http({
            method : "POST",
            url : "http://recruitment.studyinbudapest.com/profile/universities/"+id,
            data: codeprintdata
        }).then(function(response){
  ...
  $(document).on("click", ".recent-application", function(){
   ...
   var sumapplicants =  $scope.allapplctns = response.data.admission_offers.length + response.data.processed_students.length;      
    ...
    $scope.getUniversities = function (){
       ...
       $http({
            method : "POST",
            url : "http://recruitment.studyinbudapest.com/admin/universities",
            data: codeprintdata
        }).then(function(response){
...
//Student Profile Page   
    $scope.getUniversitynStudents = function (){
        ...
        $scope.admissionOffers ="0";    
        //var id = $routeParams.id;
       // $http.get('http://recruitment.studyinbudapest.com/authentication').then(function(response){
     ...
     $scope.getRcrtdStudentPrfl = function (){
        var id = $routeParams.id;  
        //$http.get('http://recruitment.studyinbudapest.com/recruited/universities/'+ id)
            
        $http({
            method : "POST",
            url : "http://recruitment.studyinbudapest.com/recruited/universities/"+id,
            data: codeprintdata
        }).then(function(response){
